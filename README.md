...
- Discover tourist destinations (Places)
- Share travel experiences (Community)
- Communicate via a modern chat system with reactions and media support
...
## 🔔 Notification System
Tracks user-specific activities such as:
- Post likes
- Post comments
...
git clone https://github.com/yourusername/travel_project.git  
cd travel_project  
...
A scalable, secure, and production-ready backend architecture for modern travel & social platforms 🚀
